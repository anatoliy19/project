...
public class RouterValidator {
    ...
    public boolean checkAccess(ServerHttpRequest request, String token) {
        ...
        String url = String.valueOf(urls.stream().filter(uri -> request.getURI().getPath().contains((CharSequence) uri)));
            Set<Map.Entry<String, List<String>>> entrySet = rolesEndpoints.entrySet();
